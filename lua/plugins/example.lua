...
-- Template for plugin as per Reddit: https://www.reddit.com/r/neovim/comments/15qr607/difficult_to_configure_things_for_lazy/
-- return {
--   {
...
--                                   -- up the plugin
--     },
--     config = function()           -- here you override the default config
